            ...
            <nav class="sidebar-nav ">
                <ul id="sidebarnav">
                        ...
                        <li>
                         ...
                         <li><hr></li>
                          ...
                          <li><a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
                                        class="flaticon-restaurant"></i><span class="hide-menu">Property</span></a>
                            <ul aria-expanded="false" class="collapse">
                  ...
                  <!--       <li><a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
                    ...
                    <li><hr></li>
                    <li><a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
                                        class="flaticon-restaurant"></i><span class="hide-menu">Document Library</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{url('admin/formcategory')}}">Form category</a></li>
                                <li><a href="{{url('admin/documentlibrary')}}">Document Libarary</a></li>
