...
Route::get('document-library','HomeController@Document')->name('documentlibrary');

Route::get('propertiesdetails/{id}','HomeController@Properties')->name('propertiesdetails');
/*Route::get('residential','HomeController@Residential')->name('residential');*/
...
Route::resource('admin/documentlibrary', 'Admin\\DocumentlibraryController');
Route::resource('admin/formcategory', 'Admin\\FormcategoryController');